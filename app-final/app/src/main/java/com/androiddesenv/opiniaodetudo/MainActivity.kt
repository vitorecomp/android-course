...
class MainActivity : AppCompatActivity(){
    ...
    fun updateReviewLocation(entity: Review) {
        LocationService(this).onLocationObtained{ lat,long ->
            val repository = ReviewRepository(this.applicationContext)
            object : AsyncTask<Void, Void, Unit>() {
                override fun doInBackground(vararg params: Void?) {
